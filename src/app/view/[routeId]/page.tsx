...
async function fetchRouteData(routeId: string): Promise<StoredRouteData | null> {
  ...
  // --- Mock Data (Updated structure & ID Handling) ---
  // Make the mock less strict about the exact ID format.
  // Return the first mock route if the ID looks like a generated one.
  // This allows viewing shared routes generated by the planner.
  ...
  if (routeId && routeId.startsWith('route-')) {
     ...
     return {
        ...
        photos: [
          { id: 'ph-mock1-1', url: 'https://picsum.photos/seed/pier39/300/200', location: { lat: 37.8087, lng: -122.4098 }, waypointId: 'wp-inter-mock1-1', description: 'Sea Lions at Pier 39' },
          { id: 'ph-mock1-2', url: 'https://picsum.photos/seed/oceanbeach2/300/200', location: { lat: 37.7588, lng: -122.5134 }, waypointId: 'wp-dest-mock1', description: 'Sunset at Ocean Beach' },
        ],
      };
  }
   else {
